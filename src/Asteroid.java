...
public class Asteroid extends CelestialObject implements Serializable {
    ...
    public Asteroid(String name, String mass, String specs, String res, double size, String composition) {
        super("Asteroid", name, mass, specs, res, size, composition, 0, 0, 0);
    ...
    public static void addAsteroid(CelestialObjectRepo repository, Scanner scanner) {
        ...
        System.out.print("Enter the resources of the asteroid: ");
        ...
        repository.addCelestialObject(new Asteroid(name, mass, specs, res, radius, composition));
    }
