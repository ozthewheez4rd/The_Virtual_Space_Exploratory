        ...
        if (celestialObjects.isEmpty()) {
            ...
            do {
                ...
                //    System.out.println("Exploring " + selectedObject.getName() + ":");
                    CelestialObjectProxy proxy = new CelestialObjectProxy(selectedObject.getType(), selectedObject.getName(), selectedObject.getMass(), selectedObject.getSpecs(), selectedObject.getResources(), selectedObject.getSize(), selectedObject.getComposition(), selectedObject.getTemperature(), selectedObject.getLuminosity(), selectedObject.getCriticalMass());
